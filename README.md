...
根据开源项目[Jetpack-MVVM-Best-Practice](https://github.com/KunMinX/Jetpack-MVVM-Best-Practice)架构重构之前使用MVC架构的项目。此项目功能并不完全，若要查看完整功能以及运行gif请查看[NeteaseCloudMusic](https://github.com/zion223/NeteaseCloudMusic)项目
